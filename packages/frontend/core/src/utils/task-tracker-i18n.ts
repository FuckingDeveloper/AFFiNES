...
const resources = {
  en: {
    ...
    newTask: 'New task',
    createTaskFailed: 'Could not reserve a task key. The task was not created.',
    registryRequired:
      'TrackWork task creation requires a synced workspace and server registry.',
    registrySyncFailed: 'Could not synchronize the TrackWork task registry.',
    relatedDocsUpdateFailed: 'Could not update related documents.',
    newBoard: 'New board',
    ...
    noSubtasks: 'No checklist items yet',
    ...
    subtasksPlaceholder: 'One checklist item per line',
    ...
    relationSearchPlaceholder: 'Search tasks',
    taskSearchEmpty: 'No matching tasks',
    blockedBadge: 'Blocked',
    relationCyclicError: 'Cannot link: would create a cycle',
    ...
    mrCreated: 'Merge request created',
    createBranchFailed: 'Failed to create branch',
    createMrFailed: 'Failed to create merge request',
    gitlabActionsUnavailable:
      'Connect GitLab and track at least one repository to create branches or merge requests.',
  ...
  ru: {
    ...
    createTaskFailed:
      'Не удалось зарезервировать ключ задачи. Задача не была создана.',
    registryRequired:
      'Для создания задач TrackWork нужно синхронизированное рабочее пространство и серверный реестр.',
    registrySyncFailed: 'Не удалось синхронизировать реестр задач TrackWork.',
    relatedDocsUpdateFailed: 'Не удалось обновить связанные документы.',
    ...
    noSubtasks: 'Пункты чек-листа пока не добавлены',
    ...
    subtasksPlaceholder: 'Один пункт чек-листа на строку',
    ...
    relatedDocsRemove: 'Удалить',
    references: 'Ссылки',
    referencesEmpty: 'Ни один документ не ссылается на эту задачу',
    referencesSearching: 'Поиск...',
    subTasksTitle: 'Подзадачи',
    subTasksEmpty: 'Подзадач нет',
    addSubtask: 'Новая подзадача',
    linkTask: 'Связать задачу',
    relationsTitle: 'Связи',
    blockedBy: 'Блокируется',
    blocks: 'Блокирует',
    relatesTo: 'Связана с',
    duplicates: 'Дублирует',
    relationSearchPlaceholder: 'Поиск задач',
    taskSearchEmpty: 'Задачи не найдены',
    blockedBadge: 'Заблокирована',
    relationCyclicError: 'Нельзя связать: получится цикл',
    createBranch: 'Создать ветку',
    developmentActions: 'Действия разработки',
    createMr: 'Создать merge request',
    repository: 'Репозиторий',
    baseBranch: 'Базовая ветка',
    branchName: 'Имя ветки',
    sourceBranch: 'Исходная ветка',
    targetBranch: 'Целевая ветка',
    mrTitle: 'Заголовок merge request',
    mrDescription: 'Описание merge request',
    branchCreated: 'Ветка создана',
    mrCreated: 'Merge request создан',
    createBranchFailed: 'Не удалось создать ветку',
    createMrFailed: 'Не удалось создать merge request',
    gitlabActionsUnavailable:
      'Подключите GitLab и включите отслеживание хотя бы одного репозитория, чтобы создавать ветки и merge request’ы.',
