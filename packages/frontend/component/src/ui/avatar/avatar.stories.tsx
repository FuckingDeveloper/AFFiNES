...
export const ColorfulFallbackWithDifferentSize: StoryFn<AvatarProps> = args => (
  <>
    <Avatar {...args} size={20} colorfulFallback name="MRH ManSys" />
    <Avatar {...args} size={40} colorfulFallback name="MRH ManSys" />
    <Avatar {...args} size={60} colorfulFallback name="MRH ManSys" />
  </>
);
...
export const CustomizeBorderRadius: StoryFn<AvatarProps> = args => (
  <div style={{ display: 'flex', gap: 4 }}>
    <Avatar {...args} size={60} colorfulFallback name="MRH ManSys" rounded={10} />
