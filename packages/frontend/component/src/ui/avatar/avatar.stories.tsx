...
DefaultAvatar.args = {
  name: 'TrackWork',
  url: 'https://trackwork.mrhsoftware.com/favicon-96.png',
  size: 50,
};
...
export const ColorfulFallbackWithDifferentSize: StoryFn<AvatarProps> = args => (
  <>
    <Avatar {...args} size={20} colorfulFallback name="TrackWork" />
    <Avatar {...args} size={40} colorfulFallback name="TrackWork" />
    <Avatar {...args} size={60} colorfulFallback name="TrackWork" />
  </>
);
