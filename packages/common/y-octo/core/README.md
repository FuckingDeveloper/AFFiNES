...
[MRH ManSys](https://affine.pro) is using y-octo in production. There are [Electron](https://affine.pro/download) app and [Node.js server](https://github.com/toeverything/AFFiNE/tree/canary/packages/backend/native) using y-octo in production.
...
[MRH ManSys]: https://github.com/toeverything/affine
