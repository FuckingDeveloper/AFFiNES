...
defineModuleConfig('server', {
  name: {
    desc: 'A recognizable name for the server. Will be shown when connected with MRH ManSys Desktop.',
    default: undefined,
    shape: z.string().optional(),
  },
  externalUrl: {
    desc: `Base url of MRH ManSys server, used for generating external urls.
