        ...
        <tr>␊
          <td>␊
            <p␊
              ...
              This is a test email from your TrackWork instance.␊
            </p>␊
          </td>␊
        </tr>␊
      </tbody>␊
    ...
    123456</pre␊
            ...
            <table␊
              ...
              <tbody style="width:100%">␊
                <tr style="width:100%">␊
                  <a␊
                    href="https://trackwork.mrhsoftware.com/magic-link?token=123456&amp;email=test@test.com"␊
...
> Your TrackWork account is waiting for you!
...
> Modify your TrackWork password
              ...
              <tbody style="width:100%">␊
                <tr style="width:100%">␊
                  <p␊
                    ...
                    with your TrackWork account.<br />To complete this process,␊
      ...
      <tbody>␊
        <tr>␊
          <td>␊
            <p␊
              style="font-size:20px;line-height:28px;font-weight:600;font-family:Inter, Arial, Helvetica, sans-serif;margin-top:24px;margin-bottom:0;color:#141414">␊
              Verify your current email for TrackWork␊
            </p>␊
          </td>␊
        </tr>␊
      </tbody>␊
              ...
              <tbody style="width:100%">␊
                <tr style="width:100%">␊
                  <p␊
                    style="font-size:15px;line-height:24px;font-weight:400;font-family:Inter, Arial, Helvetica, sans-serif;margin-top:24px;margin-bottom:0;color:#141414">␊
                    You recently requested to change the email address associated␊
                    with your TrackWork account. To complete this process, please␊
...
> test@test.com invited you to join Test Workspace
    ...
    <link␊
      rel="preload"␊
      as="image"␊
      href="https://trackwork.mrhsoftware.com/favicon-192.png" /><!--$-->␊
    <table␊
      align="center"␊
      width="100%"␊
      border="0"␊
              ...
              <tbody style="width:100%">␊
                <tr style="width:100%">␊
                  <p␊
                    ...
                    to join␊
                    <img␊
                      src="https://trackwork.mrhsoftware.com/favicon-192.png"␊
                      alt="avatar"␊
