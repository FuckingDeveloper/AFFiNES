...
В стандартном режиме используется связка `email-логин + пароль`. Email здесь
служит уникальным идентификатором пользователя; письма и magic-link для входа
не отправляются. Пользователь без пароля не может войти.
...
- сайт: <https://webtrack.mrhsoftware.com>;
- помощь: <https://webtrack.mrhsoftware.com/help>;
- поддержка: <webtrack@mrhsoftware.com>.
