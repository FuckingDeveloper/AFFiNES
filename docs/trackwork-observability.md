...
| `trackwork_function_calls_total` / `trackwork_function_timer_*` | counter / histogram | `name="scm_request"`, `provider`, `operation` (`test_connection`, `list_repositories`, `list_pipelines`, `create_branch`, `create_merge_request`), `error` |
