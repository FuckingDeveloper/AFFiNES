# MRH ManSys Cloud Copilot E2E Tests

This directory contains end-to-end tests for the MRH ManSys Cloud Copilot feature. The tests are organized in a structured way to ensure comprehensive coverage of different functionalities.
